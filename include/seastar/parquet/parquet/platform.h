...
#include <seastar/parquet/arrow/buffer.h>            // IWYU pragma: export
#include <seastar/parquet/arrow/io/interfaces.h>     // IWYU pragma: export
#include <seastar/parquet/arrow/io/memory.h>         // IWYU pragma: export
#include <seastar/parquet/arrow/memory_pool.h>       // IWYU pragma: export
#include <seastar/parquet/arrow/status.h>            // IWYU pragma: export
#include <seastar/parquet/arrow/util/bit_util.h>     // IWYU pragma: export
#include <seastar/parquet/arrow/util/compression.h>  // IWYU pragma: export
#include <seastar/parquet/arrow/util/macros.h>       // IWYU pragma: export
