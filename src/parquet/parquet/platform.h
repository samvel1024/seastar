...
#include "parquet/arrow/buffer.h"            // IWYU pragma: export
#include "parquet/arrow/io/interfaces.h"     // IWYU pragma: export
#include "parquet/arrow/io/memory.h"         // IWYU pragma: export
#include "parquet/arrow/memory_pool.h"       // IWYU pragma: export
#include "parquet/arrow/status.h"            // IWYU pragma: export
#include "parquet/arrow/util/bit_util.h"     // IWYU pragma: export
#include "parquet/arrow/util/compression.h"  // IWYU pragma: export
#include "parquet/arrow/util/macros.h"       // IWYU pragma: export
